...
exports.downloadJava = void 0;
let tempDirectory = process.env["RUNNER_TEMP"] || "";
const core = __importStar(__webpack_require__(470));
const httpm = __importStar(__webpack_require__(539));
const fs = __importStar(__webpack_require__(747));
const http = __importStar(__webpack_require__(211));
...
function downloadJava(version, arch) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const jdkUrl = yield getJdkUrl(version, arch, os);
        if (jdkUrl === undefined || jdkUrl === "") {
            throw new Error(`Couldn't find download URL for OpenJDK ${version} on ${os} with architecture ${arch}`);
        }
...
function getJdkUrl(version, arch, os) {
    return __awaiter(this, void 0, void 0, function* () {
        const http = new httpm.HttpClient("download-jdk", undefined, {
            allowRetries: true,
            maxRetries: 3
        });
        const url = "https://github.com/sormuras/bach/raw/master/install-jdk.properties";
...
Object.defineProperty(exports, "__esModule", { value: true });
const core = __importStar(__webpack_require__(470));
const downloader = __importStar(__webpack_require__(379));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield downloader.downloadJava(version, arch);
        }
        catch (error) {
